                ...
                {g.items.map((n) => {
                  ...
                  return (
                    <div key={n.id} className="flex gap-3 px-4 py-4 hover:bg-[var(--th-chip)]/30">
                      <div className="flex h-[30px] w-[30px] shrink-0 items-center justify-center rounded-[9px] border border-[var(--th-border)] bg-[var(--th-chip)] text-[13px]">{m.icon}</div>
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2 flex-wrap">
                          <span className={`h-1.5 w-1.5 rounded-full shrink-0 ${n.read ? "bg-[var(--th-border)]" : m.dot}`} aria-hidden />
                        ...
                        <div className="mt-2 flex flex-wrap items-center gap-2">
                          ...
                          <span className="rounded-full bg-[var(--th-chip)] border border-[var(--th-border)] px-2 py-0.5 text-[11px] text-[var(--th-sub)]">{m.label}</span>
                          {n.link && (
